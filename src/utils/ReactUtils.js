...
// Like `addIntegerKeys`, but with `prefix` added before each index.
...
// value set to the index of that object (as a string). Does not mutate the
// original array or the objects in that array.
